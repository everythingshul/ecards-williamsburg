...
// NOT currently written or read anywhere (a brief 2026-09 attempt to use
// this as "spent"/"remaining"'s source was reverted per direct product
// direction — see services/applicantBalance.js's getApplicantBalances,
// which strictly sums card_transactions for "spent" instead, reading 0
// until disccardpromos' transactions-array field name is confirmed rather
// than substituting a different, less trustworthy figure). Left in the
// schema rather than dropped, matching this file's own no-destructive-
// migrations rule — harmless unused columns if a future need for "the real
// balance as of last sync, independent of confirmed spend" comes up again.
